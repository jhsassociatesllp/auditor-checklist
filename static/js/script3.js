...
// Clear all tick marks (completed indicators)
const allSections = document.querySelectorAll('.section-complete, .completed, .green-tick');
allSections.forEach(section => {
    section.classList.remove('section-complete', 'completed', 'green-tick');
    const tickIcon = section.querySelector('.tick-icon, .tick');
